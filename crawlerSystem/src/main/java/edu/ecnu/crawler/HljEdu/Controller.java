package edu.ecnu.crawler.HljEdu;
...
public class Controller extends ControllerTemplate {
    ...
    public static void main(String[] args) {
        ...
        Configuration conf = new Configuration(edu.ecnu.util.Config.crawlerRoot + "/conf/webcollector-hljedu.xml");
        Controller controller = new Controller(conf);

        controller.setEduCrawlerClassName("edu.ecnu.crawler.HljEdu.HljEduCrawler");
        controller.setNextPageCrawlerClassName("edu.ecnu.crawler.HljEdu.HljNextPageCrawler");
        controller.run();
    }
...
//        BaseEduNextPageBreadthCrawler nextPageCrawler = new HljNextPageCrawler(crawldb,true);
//
...
//
//        /**********************************************/
//        BaseEduCrawler EduCrawler = new HljEduCrawler(crawldb,true);
//
