...
public class Controller extends ControllerTemplate {
    ...
    public static void main(String[] args) {
        ...
        Configuration conf = new Configuration(edu.ecnu.util.Config.crawlerRoot + "/conf/webcollector-jybedu.xml");
        Controller controller = new Controller(conf,false,true);

        controller.setEduCrawlerClassName("edu.ecnu.crawler.JybEdu.JybEduCrawler");
        controller.setNextPageCrawlerClassName("edu.ecnu.crawler.JybEdu.JybNextPageCrawler");
        controller.run();
    }
...
//        BaseEduNextPageRamCrawler nextPageCrawler = new JybNextPageCrawler();
//
...
//
//        /**********************************************/
//        BaseEduCrawler EduCrawler = new JybEduCrawler(crawldb,true);
//
