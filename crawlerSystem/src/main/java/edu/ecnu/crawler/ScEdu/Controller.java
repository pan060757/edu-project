package edu.ecnu.crawler.ScEdu;
...
public class Controller extends ControllerTemplate {
    ...
    public static void main(String[] args) {
        ...
        Configuration conf = new Configuration(edu.ecnu.util.Config.crawlerRoot + "/conf/webcollector-scedu.xml");
        Controller controller = new Controller(conf,false,true);
        controller.setEduCrawlerClassName("edu.ecnu.crawler.ScEdu.ScEduCrawler");
        controller.setNextPageCrawlerClassName("edu.ecnu.crawler.ScEdu.ScNextPageCrawler");
        controller.run();
    }
...
//        BaseEduNextPageBreadthCrawler nextPageCrawler = new ScNextPageCrawler(crawldb,true);
//
...
//
//        LOG.info("Finish crawl all the next pages. The total next pages' count is :" + nextPageCrawler.getSeeds().size());
//
//        /**********************************************/
//        BaseEduCrawler EduCrawler = new ScEduCrawler(crawldb,true);
//
...
//        EduCrawler.addSeed(nextPageCrawler.getSeeds());
//
