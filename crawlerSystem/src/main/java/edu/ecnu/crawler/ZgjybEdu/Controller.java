package edu.ecnu.crawler.ZgjybEdu;
...
public class Controller extends ControllerTemplate {
    ...
    public Controller(Configuration conf) {
        ...
        sc = new SocketCommunication(ip,4700,53);
    }
    ...
    public static void main(String[] args) {
        ...
        Configuration conf = new Configuration(edu.ecnu.util.Config.crawlerRoot + "/conf/webcollector-zgjyb.xml");
        ...
        controller.setEduCrawlerClassName("edu.ecnu.crawler.ZgjybEdu.ZgjybEduCrawler");
        controller.setNextPageCrawlerClassName("edu.ecnu.crawler.ZgjybEdu.ZgjybNextPageCrawler");
        controller.run();
...
//        BaseEduNextPageBreadthCrawler nextPageCrawler = new ZgjybNextPageCrawler(crawldb,true);
//
...
//
//        /**********************************************/
//        BaseEduCrawler EduCrawler = new ZgjybEduCrawler(crawldb,true);
//
