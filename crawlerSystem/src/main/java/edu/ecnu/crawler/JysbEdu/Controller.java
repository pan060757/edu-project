package edu.ecnu.crawler.JysbEdu;
...
public class Controller extends ControllerTemplate {
    ...
    public static void main(String[] args) {
        ...
        Configuration conf = new Configuration(edu.ecnu.util.Config.crawlerRoot + "/conf/webcollector-jysb.xml");
        Controller controller = new Controller(conf);
        controller.setEduCrawlerClassName("edu.ecnu.crawler.JysbEdu.JysbEduCrawler");
        controller.setNextPageCrawlerClassName("edu.ecnu.crawler.JysbEdu.JysbNextPageCrawler");
        controller.run();
    }
...
//        BaseEduNextPageBreadthCrawler nextPageCrawler = new JysbNextPageCrawler(crawldb,true);
//
...
//
//        /**********************************************/
//        BaseEduCrawler EduCrawler = new JysbEduCrawler(crawldb,true);
//
