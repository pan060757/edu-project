package edu.ecnu.crawler.GmwEdu;
...
public class Controller extends ControllerTemplate {
    ...
    public static void main(String[] args) {
        ...
        Configuration conf = new Configuration(edu.ecnu.util.Config.crawlerRoot + "/conf/webcollector-gmw.xml");
        Controller controller = new Controller(conf,false,true);

        controller.setEduCrawlerClassName("edu.ecnu.crawler.GmwEdu.GmwEduCrawler");
        controller.setNextPageCrawlerClassName("edu.ecnu.crawler.GmwEdu.GmwEduNextPageCrawler");
        controller.run();
    }
...
//        BaseEduNextPageRamCrawler nextPageCrawler = new GmwEduNextPageCrawler();
//
...
//
//        /**********************************************/
//        BaseEduCrawler EduCrawler = new GmwEduCrawler(crawldb,true);
//
