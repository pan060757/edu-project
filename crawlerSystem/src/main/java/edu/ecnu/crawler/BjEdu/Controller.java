package edu.ecnu.crawler.BjEdu;
...
public class Controller extends ControllerTemplate {
    ...
    public static void main(String[] args) {
        ...
        Configuration conf = new Configuration(edu.ecnu.util.Config.crawlerRoot + "/conf/webcollector-bjedu.xml");
        Controller controller = new Controller(conf);
        String suffix = conf.get("crawler.suffix");
        String publisher=conf.get("bjedu.publisher");
        String sourceId=conf.get("bjedu.sourceId");
        sc.sendMessage(sourceId +"\t"+publisher+"\t" +"start");
        controller.setEduCrawlerClassName("edu.ecnu.crawler.BjEdu.BjEduCrawler");
        controller.setNextPageCrawlerClassName("edu.ecnu.crawler.BjEdu.BjEduNextPageCrawler");
        controller.run();
...
//        BaseEduNextPageBreadthCrawler nextPageCrawler = new BjEduNextPageCrawler(crawldb+".next",true);
//
...
//
//        /**********************************************/
//        BaseEduCrawler ahEduCrawler = new BjEduCrawler(crawldb,true);
//
//
