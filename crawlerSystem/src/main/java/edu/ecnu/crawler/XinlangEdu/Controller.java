package edu.ecnu.crawler.XinlangEdu;
...
public class Controller extends ControllerTemplate {
    ...
    public Controller(Configuration conf) {
        ...
        sc = new SocketCommunication(ip,4700,42);
    }
    ...
    public static void main(String[] args) {
        ...
        Configuration conf = new Configuration(edu.ecnu.util.Config.crawlerRoot + "/conf/webcollector-xinlang.xml");
        Controller controller = new Controller(conf);
        String publisher=conf.get("xinlang.publisher");
        String sourceId=conf.get("xinlang.sourceId");
        sc.sendMessage(sourceId +"\t" + publisher + "\t" + "start");
        controller.setEduCrawlerClassName("edu.ecnu.crawler.XinlangEdu.XinglangEduCrawler");
        controller.setNextPageCrawlerClassName("edu.ecnu.crawler.XinlangEdu.XinlangNextPageCrawler");
        controller.run();
...
//        BaseEduNextPageBreadthCrawler nextPageCrawler = new XinlangNextPageCrawler(crawldb,true);
//
...
//
//        /**********************************************/
//        BaseEduCrawler EduCrawler = new XinglangEduCrawler(crawldb,true);
//
