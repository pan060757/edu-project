package edu.ecnu.crawler.IctEdu;
...
public class Controller extends ControllerTemplate {
    ...
    public static void main(String[] args) {
        ...
        Configuration conf = new Configuration(edu.ecnu.util.Config.crawlerRoot + "/conf/webcollector-ict.xml");
        Controller controller = new Controller(conf);

        controller.setEduCrawlerClassName("edu.ecnu.crawler.IctEdu.IctEduCrawler");
        controller.setNextPageCrawlerClassName("edu.ecnu.crawler.IctEdu.IctNextPageCrawler");
        controller.run();
    }

//    public static void main(String[] args) throws Exception {
//
//        Configuration conf = new Configuration(edu.ecnu.util.Config.crawlerRoot+"/conf/webcollector-ictedu.xml");
//        String suffix = conf.get("crawler.suffix");
//        String crawldb = conf.get(suffix+".crawldb");      //第一步:加载配置的crawldb,并生成对应的NextPageCrawler
//        BaseEduNextPageBreadthCrawler nextPageCrawler = new IctNextPageCrawler(crawldb,true);
//
...
//
//        /**********************************************/
//        BaseEduCrawler EduCrawler = new IctEduCrawler(crawldb,true);
//
