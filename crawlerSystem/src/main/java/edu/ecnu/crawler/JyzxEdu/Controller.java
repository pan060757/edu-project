package edu.ecnu.crawler.JyzxEdu;
...
public class Controller extends ControllerTemplate {
    ...
    public static void main(String[] args) {
        ...
        Configuration conf = new Configuration(edu.ecnu.util.Config.crawlerRoot + "/conf/webcollector-jyzxedu.xml");
        Controller controller = new Controller(conf,false,true);
        controller.setEduCrawlerClassName("edu.ecnu.crawler.JyzxEdu.JyzxEduCrawler");
        controller.setNextPageCrawlerClassName("edu.ecnu.crawler.JyzxEdu.JyzxEduNextPageCrawler");
        controller.run();
    }
...
//        BaseEduNextPageRamCrawler nextPageCrawler = new JyzxEduNextPageCrawler();
//
...
//
//        /**********************************************/
//        BaseEduCrawler EduCrawler = new JyzxEduCrawler(crawldb,true);
//
