package edu.ecnu.crawler.NmgEdu;
...
public class Controller extends ControllerTemplate {
    ...
    public static void main(String[] args) {
        ...
        Configuration conf = new Configuration(edu.ecnu.util.Config.crawlerRoot + "/conf/webcollector-nmgedu.xml");
        Controller controller = new Controller(conf);
        controller.setEduCrawlerClassName("edu.ecnu.crawler.NmgEdu.NmgEduCrawler");
        controller.setNextPageCrawlerClassName("edu.ecnu.crawler.NmgEdu.NmgNextPageCrawler");
        controller.run();
    }
...
//        BaseEduNextPageBreadthCrawler nextPageCrawler = new NmgNextPageCrawler(crawldb,true);
//
...
//
//        /**********************************************/
//        BaseEduCrawler EduCrawler = new NmgEduCrawler(crawldb,true);
//
