package edu.ecnu.crawler.ZgjyEdu;
...
public class Controller extends ControllerTemplate {
    ...
    public static void main(String[] args) {
        ...
        Configuration conf = new Configuration(edu.ecnu.util.Config.crawlerRoot + "/conf/webcollector-zgjy.xml");
        Controller controller = new Controller(conf,false,true);

        controller.setEduCrawlerClassName("edu.ecnu.crawler.ZgjyEdu.ZgjyEduCrawler");
        controller.setNextPageCrawlerClassName("edu.ecnu.crawler.ZgjyEdu.ZgjyNextPageCrawler");
        controller.run();
    }
...
//        BaseEduNextPageRamCrawler nextPageCrawler = new ZgjyNextPageCrawler();
//
...
//
//        /**********************************************/
//        BaseEduCrawler EduCrawler = new ZgjyEduCrawler(crawldb,true);
//
