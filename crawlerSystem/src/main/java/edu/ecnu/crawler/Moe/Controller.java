...
public class Controller extends ControllerTemplate {
    ...
    public static void main(String[] args) {
        ...
        Configuration conf = new Configuration(edu.ecnu.util.Config.crawlerRoot + "/conf/webcollector-moe.xml");
        Controller controller = new Controller(conf,false,true);
        controller.setEduCrawlerClassName("edu.ecnu.crawler.Moe.MoeEduCrawler");
        controller.setNextPageCrawlerClassName("edu.ecnu.crawler.Moe.MoeNextPageCrawler");
        controller.run();
    }
...
//        BaseEduNextPageBreadthCrawler nextPageCrawler = new MoeNextPageCrawler(crawldb,true);
//
...
//
//        /**********************************************/
//        BaseEduCrawler EduCrawler = new MoeEduCrawler(crawldb,true);
//
