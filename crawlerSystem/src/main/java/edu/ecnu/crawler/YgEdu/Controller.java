...
public class Controller extends ControllerTemplate {
    ...
    public static void main(String[] args) {
        ...
        Configuration conf = new Configuration(edu.ecnu.util.Config.crawlerRoot + "/conf/webcollector-ygedu.xml");
        Controller controller = new Controller(conf,false,true);

        controller.setEduCrawlerClassName("edu.ecnu.crawler.YgEdu.YgEduCrawler");
        controller.setNextPageCrawlerClassName("edu.ecnu.crawler.YgEdu.YgEduNextPageCrawler");
        controller.run();
    }
...
//        BaseEduNextPageRamCrawler nextPageCrawler = new YgEduNextPageCrawler();
//
...
//
//        /**********************************************/
//        BaseEduCrawler ahEduCrawler = new YgEduCrawler(crawldb,true);
//
//
