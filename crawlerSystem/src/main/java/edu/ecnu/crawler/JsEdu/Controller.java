package edu.ecnu.crawler.JsEdu;
...
public class Controller extends ControllerTemplate {
    ...
    public static void main(String[] args) {
        ...
        Configuration conf = new Configuration(edu.ecnu.util.Config.crawlerRoot + "/conf/webcollector-jsedu.xml");
        Controller controller = new Controller(conf,false,true);

        controller.setEduCrawlerClassName("edu.ecnu.crawler.JsEdu.JsEduCrawler");
        controller.setNextPageCrawlerClassName("edu.ecnu.crawler.JsEdu.JsNextPageCrawler");
        controller.run();
    }
//    public static void main(String[] args) throws Exception {
//
//        Configuration conf = new Configuration("WebCollector/conf/webcollector-jsedu.xml");
//        String suffix = conf.get("crawler.suffix");
//        String crawldb = conf.get(suffix+".crawldb");      //第一步:加载配置的crawldb,并生成对应的NextPageCrawler
//        BaseEduNextPageRamCrawler nextPageCrawler = new JsNextPageCrawler();
...
//
//        /**********************************************/
//        BaseEduCrawler EduCrawler = new JsEduCrawler(crawldb,true);
//
