package edu.ecnu.crawler.Fjedu;
...
public class Controller extends ControllerTemplate {
    ...
    public static void main(String[] args) {
        ...
        Configuration conf = new Configuration(edu.ecnu.util.Config.crawlerRoot + "/conf/webcollector-fjedu.xml");
        Controller controller = new Controller(conf);
        controller.setEduCrawlerClassName("edu.ecnu.crawler.Fjedu.FjEduCrawler");
        controller.setNextPageCrawlerClassName("edu.ecnu.crawler.Fjedu.FjEduNextPageCrawler");
        controller.run();
    }
...
//        BaseEduNextPageBreadthCrawler nextPageCrawler = new FjEduNextPageCrawler(crawldb,true);
//
...
//
//        /**********************************************/
//        BaseEduCrawler EduCrawler = new FjEduCrawler(crawldb,true);
//
