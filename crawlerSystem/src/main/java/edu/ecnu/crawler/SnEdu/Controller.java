package edu.ecnu.crawler.SnEdu;
...
public class Controller extends ControllerTemplate {
    ...
    private static String ip;
        public Controller(Configuration conf) {
            ...
            sc = new SocketCommunication(ip,4700,35);
    ...
    public static void main(String[] args) {
        ...
        Configuration conf = new Configuration(edu.ecnu.util.Config.crawlerRoot + "/conf/webcollector-snedu.xml");
        Controller controller = new Controller(conf);
        String publisher=conf.get("snedu.publisher");
        String sourceId=conf.get("snedu.sourceId");
        sc.sendMessage(sourceId +"\t" + publisher + "\t" + "start");
        controller.setEduCrawlerClassName("edu.ecnu.crawler.SnEdu.SnEduCrawler");
        controller.setNextPageCrawlerClassName("edu.ecnu.crawler.SnEdu.SnNextPageCrawler");
        controller.run();
...
//        BaseEduNextPageBreadthCrawler nextPageCrawler = new SnNextPageCrawler(crawldb,true);
//
...
//
//        /**********************************************/
//        BaseEduCrawler EduCrawler = new SnEduCrawler(crawldb,true);
//
